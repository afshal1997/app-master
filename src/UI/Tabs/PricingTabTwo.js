        ...
        <>
            <Row>
                <Col lg={3}>
                    <Card className='shadow'>
                        <Card.Body>
                            ...
                            <h5 className="text-muted">$670 / mo</h5>
                            <Card.Text>
                                <ul>
                                    <li>
                ...
                <Col lg={3}>
                    <Card className='shadow'>
                        <Card.Body>
                            ...
                            <h5 className="text-muted">$1,270 / mo</h5>
                            <Card.Text>
                                <ul>
                                    <li>
                ...
                <Col lg={3}>
                    <Card className='shadow'>
                        <Card.Body>
                            ...
                            <h5 className="text-muted">$1,970 / mo</h5>
                            <Card.Text>
                                <ul>
                                    <li>
                                        Everything in Essentials
                ...
                <Col lg={3}>
                    <Card className='shadow'>
                        <Card.Body>
                            <h2 className='mb-0'>Enterprise</h2>
                            <h5 className="text-muted">$5,000 / mo</h5>
                            <Card.Text>
                                <ul>
                                    <li>
